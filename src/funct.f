...
!     1. Magnetic axis forces: to artificially freeze axis at R0N,Z0N values
!                              (set in inguess), set these to zero
!
      m = 0
